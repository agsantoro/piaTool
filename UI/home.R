  ...
  <div id="div_1" class="h-auto w-1/4 h-auto w-1/4 py-4" style="background-color: #FF671B; display: flex; flex-direction: column; align-items: flex-start;" style="background-color: #FF671B">
    ...
    <div>
      <div class="flex w-full items-center py-3 text-2xl">
        <div class="pl-9 text-white ">
          <svg class="fill-white" xmlns="http://www.w3.org/2000/svg" height="4em" viewBox="0 0 512 512">
    ...
    <div>
      <div class="flex w-full items-center justify-center py-3 text-2xl">
        <div class="pl-9 text-white">
          <svg fill="white" height="4em" width="4em" version="1.2" baseProfile="tiny" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-217 51 256 256" xml:space="preserve">
            <path
