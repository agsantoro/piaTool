...
<div class="flex h-screen">
  <div class="relative h-auto w-3/4">
    <div class="h-full bg-cover bg-center bg-[url(medicines-1500x540.webp)]" ></div>
    <div class="absolute inset-0 flex items-center justify-center">
      <p class="px-4 text-center text-white text-4xl">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis fermentum quam in dictum aliquet. Vestibulum non ante a mi bibendum facilisis at vitae libero. Integer id aliquam sapien.</p>
    </div>
  </div>
  <div class="h-auto w-1/4" style="background-color: #FF671B">
    <div>
      <div class="flex w-full items-center justify-center py-3">
        <div class="pl-9 text-white">
          <svg class="fill-white" xmlns="http://www.w3.org/2000/svg" height="6em" viewBox="0 0 512 512">
        ...
        <div class="px-9 text-white">
          ...
          <div>Modelo de evaluación del impacto epidemiológico y de costo-efectividad de la vacunación contra el virus del papiloma humano (VPH) en niñas para la prevención del cáncer de cuello uterino por país.</div>
        </div>
      </div>
    </div>
    ...
    <div>
      <div class="flex w-full items-center justify-center py-3">
        ...
        <div class="px-9 text-white">
          ...
          <div>Modelo de evaluación del impacto epidemiológico y de costo-efectividad del control de la presión arterial con tratamiento farmacológico en personas con hipertensión arterial ya diagnosticadas en el marco de la iniciativa HEARTS para la reducción de la mortalidad relacionada con enfermedades cardíacas isquémicas (ECI) y accidentes cerebrovasculares (ACV) por país.</div>
        </div>
      </div>
    </div>
    ...
    <div>
      <div class="flex w-full items-center justify-center py-3">
        <div class="pl-9 text-white">
          <svg fill="white" height="6em" width="6em" version="1.2" baseProfile="tiny" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-217 51 256 256" xml:space="preserve">
            <path
        ...
        <div class="px-9 text-white">
          ...
          <div>Modelo de evaluación del impacto epidemiológico del uso de oxitocina durante el parto para la prevención de hemorragia postparto y mortalidad materna por país.</div>
        </div>
      </div>
    </div>
